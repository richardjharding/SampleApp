namespace Sprydon.Portal.Constants
{
    public static class HomeControllerRoute
    {
        ...
        public const string GetClaims = ControllerName.Home + "GetClaims";
        public const string GetUsers = ControllerName.Home + "GetListUsers";
        public const string GetFetchUsers = ControllerName.Home + "GetFetchUsers";
    }
}